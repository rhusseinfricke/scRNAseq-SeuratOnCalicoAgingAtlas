...
```{r}
rio::export(worm_cc_genes, file = file.path("/Users/reemhussein-fricke/Desktop/Calico","cell_cycle","Caenorhabditis_elegans.csv"))
```
...
```{r}
rio::export(worm_ct_genes, file = file.path("/Users/reemhussein-fricke/Desktop/Calico","cell_type","Caenorhabditis_elegans.csv"))
```
